                        ...
                        <div class="wm-event wm-event-grid">
                            <ul class="row">
                                ...
                                <li class="col-md-4 wm-cancelled">
                                    <div class="wm-event-grid-wrap">
                                        <figure><a href="/events/single"><img src="{{asset('assets')}}/extra-images/event-grid-5.jpg" alt=""></a>
                                ...
                                <li class="col-md-4">
                                    <div class="wm-event-grid-wrap">
                                        <figure><a href="/events/single"><img src="{{asset('assets')}}/extra-images/event-grid-6.jpg" alt=""></a>
                                ...
                                <li class="col-md-4">
                                    <div class="wm-event-grid-wrap">
                                        <figure><a href="/events/single"><img src="{{asset('assets')}}/extra-images/event-grid-1.jpg" alt=""></a>
                                            <span class="wm-event-label">Open</span>
                                            <figcaption class="wm-bgcolor">
                                                <span>25</span> <span>03</span> <span>16</span>
                                            </figcaption>
                                ...
                                <li class="col-md-4">
                                    <div class="wm-event-grid-wrap">
                                        <figure><a href="/events/single"><img src="{{asset('assets')}}/extra-images/event-grid-2.jpg" alt=""></a>
                                            <span class="wm-event-label">Open</span>
                                            <figcaption class="wm-bgcolor">
                                                <span>24</span> <span>04</span> <span>16</span>
                                            </figcaption>
                                ...
                                <li class="col-md-4">
                                    <div class="wm-event-grid-wrap">
                                        <figure><a href="/events/single"><img src="{{asset('assets')}}/extra-images/event-grid-3.jpg" alt=""></a>
                                            <span class="wm-event-label wm-fewtickets">Few Tickets</span>
                                            <figcaption class="wm-bgcolor">
